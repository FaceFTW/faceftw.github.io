...
<Image src={thinkpadMentioned} alt="THINKPAD MENTIONED!!!!!" width={1200} height={800} className='mx-auto mb-4'/>
...
<div className='text-center'>
<Image src={thinkpadLid} alt="The lid of my Thinkpad" width={1200} height={900} className='mx-auto mb-4'/>
...
<div className='text-center'>
<Image src={mySonGPU} alt="my son :)" width={1200} height={1600} className='mx-auto mb-4'/>
<em>my son :)</em>
</div>
...
<div className='text-center'>
<Image src={buildInside} alt="Inside of the computer" width={1200} height={900} className='mx-auto'/>
<Image src={buildFront} alt="Front of the computer" width={1200} height={1600} className='mx-auto'/>
