...
import thinkpadLid from './thinkpad_lid.webp';

<div className='text-center'>
<Image src={thinkpadLid} alt="The lid of my Thinkpad" width={5712} height={4284} className='mx-auto mb-4'/>
...
- MB: Asus TUF Gaming B650M-PLUS Wifi (mATX AM5)
- Memory: TeamGroup T-Create Expert 2x16GB DDR5 6000 MT/s CL-30
- Storage: SK Hynix Platnium P41 - 2TB PCIe 4.0 (4 Lane)
...
import mySonGPU from './my_son.webp';

<div className='text-center'>
<Image src={mySonGPU} alt="my son :)" width={4284} height={5712} className='mx-auto mb-4'/>
<em>my son :)</em>
</div>
...
- Parts are not the top-echelon but are still competitive
  - The main usecases I have are software development, gaming, and the occasional CAD/3D modeling for 3D Printing. More CPU cores and the Ryzen's overall dominance in multi-threading made the most sense overall.
...
Here are pictures of the final build! I'm excluding a formal setup picture since I'm still adusting things around, plus it's temporary while I save for an apartment.

import buildInside from './build_inside.webp';
import buildFront from './build_front.webp';

<div className='text-center'>
<Image src={buildInside} alt="Inside of the computer" width={5712} height={4284} className='mx-auto'/>
<Image src={buildFront} alt="Front of the computer" width={5712} height={4284} className='mx-auto'/>
...
import threeDMark from './3dmark.webp';

<div className='text-center'>
<Image src={threeDMark} alt="3DMark Scores" width={607} height={916} className='mx-auto mb-4'/>
