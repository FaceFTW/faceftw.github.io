...
<div>
<Image src={exceptionStylesExample} width={738} height={831} className='mx-auto mb-4'/>
</div>
...
<div>
<Image src={seeminglyhighcouplingexample} width={806} height={520} className='mx-auto mb-4'/>
</div>
...
<div>
<Image src={presentationLayer} width={910} height={1044} className='mx-auto mb-4'/>
</div>
...
<div>
<Image src={basicStrategy} width={380} height={381} className='mx-auto mb-4'/>
</div>
