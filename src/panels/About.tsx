		...
		<Box>
			...
			<Box sx={{ display: 'flex', m: '1.25rem' }}>
				<Box sx={{ width: { sm: '50%' } }}>
					...
					<p>
						I love to explore new areas where technology can be integrated, and this is a passion I expect
						to be pursuing for the rest of my life. Thanks for visiting and seeing what I have learned over
						the variety of experiences I have gone through!
					</p>
				</Box>
