...
const SocialSection = () => {
	const [gpgCopied, setGpgCopied] = React.useState(false);
	const copyGpgKey = () => {
	...
	return (
		<motion.div
			...
			<h1 className='mb-4 mt-8 text-xl md:mt-0'>
			...
			<div className='flex flex-row items-center gap-8'>
				...
				<TooltipProvider>
					...
					<Tooltip>
						<TooltipTrigger asChild>
							<Button variant='link' className={iconSizeClass} size='icon' asChild onClick={() => copyGpgKey}>
								<Key className={iconSizeClass} />
							</Button>
						</TooltipTrigger>
						<TooltipContent>{gpgTooltip}</TooltipContent>
					</Tooltip>
				</TooltipProvider>
		...
		<section>
			<motion.div
				...
				<div className='flex flex-col lg:flex-row'>
					<div className='m-8'>
						<img src={Pfp} className='h-48 w-48 rounded-full border-8 transition-all hover:border-primary' />
					</div>
